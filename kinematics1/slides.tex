...
\begin{document}
	\begin{frame}{Problem 15}
		...
		\begin{center}
			\only<1>{\input{figs/diagram_1.tex}}
			\only<2>{\input{figs/diagram_2.tex}}
			\only<3>{\input{figs/diagram_3.tex}}
		\end{center}
	...
	\begin{frame}{Problem 15}
		...
		\begin{align*}
			...
			\onslide<4->{&= \frac{1}{2}(4m)\left(\frac{v_0}{3}\right)^2 = \frac{1}{18}mv^2_0 \\}
